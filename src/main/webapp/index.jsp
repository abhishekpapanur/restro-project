...
<head>
    ...
    <title>DevOps Demo By Ritesh</title>
            ...
            <ul class="navbar-nav d-flex justify-content-between">
                ...
                <div class="d-flex flex-lg-row flex-column">
                    <li class="nav-item active">
                        <a class="nav-link" href="/restro">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="inner container">
         <div class="row">
         	...
         	<div class="col-md-12 d-flex align-items-center">
         		<p class="mx-auto text-center mb-0">Copyright 2021. All Right Reserved. Ritesh and Sourabh<a href="https://gettemplates.co" target="_blank"> </a></p>
         	</div>
